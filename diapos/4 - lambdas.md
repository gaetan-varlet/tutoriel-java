...
Pour trier les éléments d'une collection, la classe de l'objet doit implémenter l'interface **Comparable** en redéfinissant la méthode **int compareTo(T other)**. Certaines classes comme *String* ou *Integer* le font déjà :
